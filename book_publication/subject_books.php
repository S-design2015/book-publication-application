...
$stmt = mysqli_prepare($conn, "SELECT id, name FROM subjects WHERE id=?");
...
$sql = "SELECT b.id, b.title, b.author, b.cover_image
        FROM books b
        WHERE b.subject_id = ? AND b.status = 'approved'
...
<h1 class="mb-4">Subject: <?php echo htmlspecialchars($subject['name']); ?></h1>

<div class="row g-3">
<?php if (mysqli_num_rows($books) === 0): ?>
    <p>No approved books for this subject yet.</p>
<?php else: ?>
